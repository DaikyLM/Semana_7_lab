...
public class Jabon extends JFrame implements ActionListener {
	...
	public Jabon() {
		...
		cboMarca.setModel(new DefaultComboBoxModel(new String[] {"Palmolive Tripack", "Nivea Tripack", "Rexona Tripack", "Neko Tripack"}));
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		if(marca=="Palmolive Tripack"){pre=5.2;}
		else if(marca=="Nivea Tripack") {pre=8.2;}
		else if(marca=="Rexona Tripack") {pre=6.5;}
		else {pre=7.4;}
